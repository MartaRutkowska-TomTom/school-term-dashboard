function init() {
  ...
  const DATA = {
    London: ['City of London','Camden','Croydon','Ealing','Greenwich','Hackney','Haringey','Harrow','Havering','Hillingdon','Hounslow','Islington','Kensington','Lambeth','Waltham','Wandsworth','Westminster','Ilford'],
    England: ['Bristol','Bury','Chatham','Cheadle','Fareham','Gillingham','Leeds','Manchester','Oldham','Oxford','Plymouth','Sale','Sheffield','Southampton','Stockport','Warrington','Wigan'],
